<template>
	...
	<view class="container">
		<view class="addr">
			<view class="addrInfo" @click="goConfirmOrder">
				<view class="addrInfo_details">
					<view class="middle-title">姓名：小明</view>
					<view class="middle-title">联系方式：1234567890</view>
				</view>
				<view class="middle-title-light">合肥市xxxxxxxxxxxxxxx</view>
			</view>

			<view class="addr_do">
				<view v-if='true'>
					<radio color="#CE0000" checked='true'>设为默认</radio>
				</view>
				<view v-else>
					<radio color="#CE0000" checked=''>设为默认</radio>
				</view>
